...
const RAW_CODE_REGISTRY = {
  ...
  'lifecycle.open_failed': {
    ...
    title: 'Open Failed',
    render: 'failsafe-failed',
  },
  'lifecycle.add_confirmed': {
    category: 'LIFECYCLE',
    severity: 'info',
    audience: 'feed',
  ...
  'lifecycle.close_confirmed': {
    category: 'LIFECYCLE',
    severity: 'info',
    audience: 'feed',
    title: 'Closed DLMM Position',
    render: 'close',
  },
  ...
  'detect.leader_position_not_found': {
    category: 'DETECT',
    severity: 'warn',
    audience: 'internal',
  },
  ...
  'filter.below_min_market_cap': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Market Cap Below Min',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  'filter.min_market_cap_unavailable': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Market Cap Unavailable',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  'filter.below_min_holders': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Holders Below Min',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  'filter.min_holders_unavailable': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Holders Unavailable',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  'filter.below_min_24h_volume': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — 24h Volume Below Min',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  'filter.min_24h_volume_unavailable': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — 24h Volume Unavailable',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  'filter.below_min_organic_score': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Organic Score Below Min',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  'filter.min_organic_score_unavailable': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Organic Score Unavailable',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  'filter.below_min_price_range': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Price Range Below Min',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  'filter.min_price_range_unavailable': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Price Range Unavailable',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  'filter.above_max_price_change': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Price Change Above Max',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  'filter.max_price_change_unavailable': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Price Change Unavailable',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  'filter.below_min_token_age': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Token Age Below Min',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  'filter.min_token_age_unavailable': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Token Age Unavailable',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  'filter.ignored_token': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Ignored Token',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  'filter.single_pool_per_token': {
    category: 'FILTER',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Already In This Token',
    render: 'skipped-filter',
    coalesceMs: FEED_COALESCE_MS,
  },
  ...
  'cap.max_open_positions': {
    ...
    severity: 'warn',
    audience: 'feed',
    title: 'No Copy — Max Open Positions',
    render: 'skipped-cap',
    coalesceMs: FEED_COALESCE_MS,
  },
  'cap.max_concurrent_per_token': {
    category: 'CAP',
    severity: 'warn',
    audience: 'feed',
    title: 'No Copy — Max Concurrent Per Token',
    render: 'skipped-cap',
    coalesceMs: FEED_COALESCE_MS,
  },
  'cap.max_opens_per_window': {
    category: 'CAP',
    severity: 'warn',
    audience: 'feed',
    title: 'No Copy — Max Opens Per Window',
    render: 'skipped-cap',
    coalesceMs: FEED_COALESCE_MS,
  },
  'cap.max_total_exposure': {
    category: 'CAP',
    severity: 'warn',
    audience: 'feed',
    title: 'No Copy — Max Total Exposure',
    render: 'skipped-cap',
    coalesceMs: FEED_COALESCE_MS,
  },
  ...
  'cap.infinite_add_skipped': {
    ...
    severity: 'info',
    audience: 'feed',
    title: 'Skipped Add — Infinite-Add Off',
    render: 'add',
    coalesceMs: FEED_COALESCE_MS,
  },

  // ── sizing / balance ───────────────────────────────────────────────────────────────────────────────────────
  'sizing.below_min_floor': {
    category: 'SIZING',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Below Min Size Floor',
    render: 'skipped-sizing',
    coalesceMs: FEED_COALESCE_MS,
  },
  ...
  'eligibility.non_sol_paired': {
    category: 'ELIGIBILITY',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Non-SOL Pair',
    render: 'skipped-eligibility',
    coalesceMs: FEED_COALESCE_MS,
  },
  'eligibility.token2022_deposit_failed': {
    category: 'ELIGIBILITY',
    severity: 'error',
    audience: 'feed',
    title: 'Skipped — Token-2022 Deposit Failed',
    render: 'skipped-eligibility',
  },
  'eligibility.twosided.unbuyable': {
    category: 'ELIGIBILITY',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Token Unbuyable',
    render: 'skipped-eligibility',
    coalesceMs: FEED_COALESCE_MS,
  },
  'eligibility.twosided.token2022_too_wide': {
    category: 'ELIGIBILITY',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Token-2022 Range Too Wide',
    render: 'skipped-eligibility',
    coalesceMs: FEED_COALESCE_MS,
  },
  ...
  'reshape.token_unbuyable': {
    ...
    severity: 'info',
    audience: 'feed',
    title: 'Reshape Skipped — Token Unbuyable',
    render: 'skipped-eligibility',
    coalesceMs: FEED_COALESCE_MS,
  },
  ...
  'swap.below_min_sell_out': {
    category: 'SWAP',
    severity: 'info',
    audience: 'feed',
    title: 'Skipped — Below Min Sell-Out',
    render: 'skipped-sizing',
    coalesceMs: FEED_COALESCE_MS,
  },
  'swap.executed': {
    ...
    severity: 'info',
    audience: 'feed',
    title: 'Swapped to SOL',
    render: 'swap',
  },
  'swap.failed_after_retries': {
    category: 'SWAP',
    severity: 'error',
    audience: 'feed',
    pinned: true,
  ...
  'failsafe.failed': {
    ...
    pinned: true,
    coalesceMs: PINNED_COALESCE_MS,
    title: 'Failsafe FAILED — close manually',
    render: 'failsafe-failed',
  },
  'failsafe.orphan_closed': {
    category: 'FAILSAFE',
    severity: 'warn',
    audience: 'feed',
    pinned: true,
    coalesceMs: PINNED_COALESCE_MS,
    title: 'Orphan Auto-Closed',
    render: 'failsafe-activated',
  },
  'failsafe.rug_sl_triggered': {
    category: 'FAILSAFE',
    severity: 'warn',
    audience: 'feed',
    pinned: true,
    coalesceMs: PINNED_COALESCE_MS,
    title: 'Rug Stop-Loss Triggered',
    render: 'failsafe-activated',
  },
  ...
  'system.detection_stale': {
    category: 'SYSTEM',
    severity: 'error',
    audience: 'feed',
    pinned: true,
    coalesceMs: PINNED_COALESCE_MS,
    title: 'Detection Stale — bot may be blind (check RPC/key)',
    render: 'system-fatal',
  },
